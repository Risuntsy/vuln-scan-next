          ...
          <TabsContent value="vulnerabilities" className="m-0">
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示漏洞严重程度分布饼图</div>
                  </div>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示漏洞发现趋势折线图</div>
                  </div>
                </CardContent>
              </Card>
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示漏洞类型分布柱状图</div>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <TabsContent value="assets" className="m-0">
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示资产类型分布饼图</div>
                  </div>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示资产发现趋势折线图</div>
                  </div>
                </CardContent>
              </Card>
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示Web技术分布柱状图</div>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <TabsContent value="scans" className="m-0">
            <div className="grid gap-6 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示扫描任务状态分布饼图</div>
                  </div>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示扫描任务趋势折线图</div>
                  </div>
                </CardContent>
              </Card>
              <Card className="md:col-span-2">
                ...
                <CardContent>
                  <div className="h-80 flex items-center justify-center">
                    <div className="text-center text-muted-foreground">此处显示扫描时间分布柱状图</div>
                  </div>
                </CardContent>
              </Card>
            </div>
