                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>输入用于识别该指纹的正则表达式或匹配规则，支持正则表达式语法</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>输入一些能够匹配上述规则的示例字符串，有助于验证规则的正确性</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="输入关于此指纹的描述信息（可选）" className="h-20" {...field} />
                      </FormControl>
                      <FormDescription>可选的描述信息，如版本识别方法、安全风险等</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
