...
export const mockProjectResults = {
  "proj-001": {
    assets: {
      ...
      ports: [
        { ip: "192.168.1.1", port: 80, service: "http", version: "nginx/1.20.1", discoveredAt: "2023-10-15T09:18:00Z" },
        { ip: "192.168.1.1", port: 443, service: "https", version: "nginx/1.20.1", discoveredAt: "2023-10-15T09:18:30Z" },
        { ip: "192.168.1.2", port: 80, service: "http", version: "nginx/1.20.1", discoveredAt: "2023-10-15T09:32:00Z" },
        { ip: "192.168.1.2", port: 443, service: "https", version: "nginx/1.20.1", discoveredAt: "2023-10-15T09:32:30Z" },
        { ip: "192.168.1.3", port: 22, service: "ssh", version: "OpenSSH 8.4", discoveredAt: "2023-10-15T10:47:00Z" },
        { ip: "192.168.1.3", port: 80, service: "http", version: "Apache/2.4.46", discoveredAt: "2023-10-15T10:48:00Z" },
        { ip: "192.168.1.25", port: 3306, service: "mysql", version: "MySQL 8.0.26", discoveredAt: "2023-10-15T11:22:00Z" }
      ]
    },
    vulnerabilities: [
      {
