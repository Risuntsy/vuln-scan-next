...
abc.example.com 导入子域名`}
            ...
            <FormSection>
                ...
                <div className="flex flex-col sm:flex-row gap-2 mb-2">
                    <Select
                        value={portType}
                        onValueChange={(value) => setPortType(value as "all" | "common" | "web" | "custom")}
                    >
                        <SelectTrigger>
            ...
            <FormGrid className="mt-4">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex flex-col space-y-2">
                        ...
                        <SwitchOption
                            id="associateIPs"
                            checked={associateIPs}
                            onChange={setAssociateIPs}
                            label="关联解析IP"
                        />
                        <SwitchOption
                            id="associateCertIPs"
            ...
            <FormSection>
                ...
                <SwitchOption
                    id="enableScanning"
                    checked={enableScanning}
                    onChange={setEnableScanning}
                    label="开启资产探测"
                />
            </FormSection>
