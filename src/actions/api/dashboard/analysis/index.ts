...
import type { DashboardTotalTypes, UserAccessSource, WeeklyUserActivity, MonthlySales, VersionData } from "./types";
...
export const UPDATEsYSTEMApi = (server: string, scan: string, key: string): Promise<IResponse<VersionDataResponse>> => {
