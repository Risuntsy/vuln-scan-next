...
export const updateStatusApi = (id: string, tp: string, status: number): Promise<IResponse<AssetChangeLog[]>> => {
...
export const getPageMonitoringResponseApi = (id: string, flag: string): Promise<IResponse<PageMResponse>> => {
    return request.post({
...
export const addTagApi = (id: string, tp: string, tag: string): Promise<IResponse<commonRespData>> => {
    return request.post({ url: "/api/data/add/tag", data: { id, tp, tag } });
};

export const deleteTagApi = (id: string, tp: string, tag: string): Promise<IResponse<commonRespData>> => {
