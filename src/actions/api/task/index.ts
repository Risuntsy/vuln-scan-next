...
export const deleteScheduledTaskPageMonitApi = (ids: string[]): Promise<IResponse<commonRespData>> => {
...
export const saveTemplateDetailApi = (result: Record<string, any>, id: string): Promise<IResponse<TemplateDetail>> => {
